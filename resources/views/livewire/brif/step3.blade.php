        ...
        <form wire:submit='save' class="space-y-6 md:space-y-8">
            ...
            <div class="form-control">
                <div class="flex flex-col md:flex-row md:items-baseline md:gap-2 mb-1.5 md:mb-2">
                    ...
                    <span class="label-text text-xs text-[#6B6B6B] italic md:italic">*название, ссылка на сайт</span>
                </div>
                ...
                <div class="space-y-3 md:space-y-4">
                    @foreach ($form->concurents as $index => $concurent)
                        <div wire:key='concurent-{{ $index }}' class="flex flex-col md:flex-row gap-2 md:gap-3">
                            <div class="flex-1">
                            ...
                            <div class="flex-1">
                                <div class="relative">
                                    <div class="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#6B6B6B] z-10">
