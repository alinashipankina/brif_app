    ...
    <div class="card-body p-8 md:p-10">
        ...
        <form wire:submit='save' class="space-y-8" wire:ignore.self>
            ...
            <div class="form-control">
                ...
                <div class="space-y-2">
                    @foreach ([
        'от 40к до 100к рублей в месяц' => 'от 40 000 до 100 000 ₽',
        'от 100к до 250к рублей в месяц' => 'от 100 000 до 250 000 ₽',
        'от 250к до 500к рублей в месяц' => 'от 250 000 до 500 000 ₽',
        'от 500к до 1 млн рублей в месяц' => 'от 500 000 до 1 000 000 ₽',
        'от 1 млн рублей в месяц' => 'от 1 000 000 ₽',
    ] as $value => $label)
                        <label
