        ...
        <div class="card-body p-8">
            ...
            <form class="space-y-6">
                ...
                <div class="form-control">
                    ...
                    <input type="text" placeholder="Иванов Иван Иванович, ООО 'Ромашка'"
                ...
                <div class="form-control">
                    ...
                    <input type="text" placeholder="Директор по развитию"
                           class="input input-bordered w-full focus:input-primary focus:outline-none h-12" />
                </div>
                ...
                <div class="form-control">
                    ...
                    <select class="select select-bordered w-full focus:select-primary focus:outline-none h-12">
                        ...
                        <option>Дизайн логотипа</option>
                        <option>SEO-оптимизация</option>
                ...
                <!-- Кнопка "Далее" -->
                <div class="pt-6">
                    <a type="button" href="/brif-seo-step" class="btn btn-primary w-full h-14 text-lg font-semibold">
                        Далее
