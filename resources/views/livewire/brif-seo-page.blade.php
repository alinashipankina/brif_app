    ...
    <div class="card-body p-8">
        ...
        <form wire:submit='save' class="space-y-6">
            ...
            <div class="form-control">
                ...
                <div class="relative">
                    ...
                    @foreach ($form->urls as $index => $url)
                        <div wire:key='form.urls.{{ $index }}' class="mt-2">
                            <input type="text" wire:model='form.urls.{{ $index }}'
            ...
            <div class="form-control">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                    <label class="cursor-pointer label justify-start gap-3 p-4 border rounded-lg hover:border-primary">
                        <input wire:model='form.year' type="radio" value="Менее года" name="experience"
                            class="radio radio-primary" />
                        <span class="label-text">Менее года</span>
                    </label>
                    <label class="cursor-pointer label justify-start gap-3 p-4 border rounded-lg hover:border-primary">
                        <input wire:model='form.year' type="radio" value="1-3 года" name="experience"
                            class="radio radio-primary" />
                        <span class="label-text">1-3 года</span>
                    </label>
                    <label class="cursor-pointer label justify-start gap-3 p-4 border rounded-lg hover:border-primary">
                        <input wire:model='form.year' type="radio" value="3-5 лет" name="experience"
                            class="radio radio-primary" />
                        <span class="label-text">3-5 лет</span>
                    </label>
                    <label class="cursor-pointer label justify-start gap-3 p-4 border rounded-lg hover:border-primary">
                        <input wire:model='form.year' type="radio" value="более 5 лет" name="experience"
                            class="radio radio-primary" />
            ...
            <div class="form-control">
                ...
                <input wire:model='form.geography' type="text" placeholder="Москва, Санкт-Петербург, Россия"
                    class="input input-bordered w-full focus:input-primary focus:outline-none h-12" />
            </div>
            ...
            <div class="form-control">
                ...
                <div class="space-y-3">
                    ...
                    <label class="flex items-center p-4 border rounded-lg cursor-pointer hover:border-primary">
                        <input wire:model='form.summa' type="radio" name="budget"
            ...
            <div class="flex justify-between pt-6 gap-4">
                ...
                <button type="submit" href="/brif-step-third"
                    class="btn btn-primary w-1/2 h-14 text-lg font-semibold">
                    Далее
